...
def proof_exists(label, directory='searcher', proofdir='proofs'):
    return os.path.exists(directory+'/'+proofdir+'/'+label)
...
class Proof:
    ...
    def save(self, directory='searcher/proofs'):
