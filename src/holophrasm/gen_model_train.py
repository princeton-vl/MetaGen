...
class Model(DefaultModel):
    def __init__(self, variables, config, proof_step, train=False, target_index=None):
        ...
        self.parse_and_augment_proof_step(proof_step, target_index=target_index)
    ...
    def parse_and_augment_proof_step(self, proof_step, out=True, target_index=None):
