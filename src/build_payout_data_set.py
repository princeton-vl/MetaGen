...
import interface_torch_models as interface
import withpool
...
def initialize_interface(args, lm, directory):
    global global_interface
    global global_lm
    global_interface = interface.ProofInterface(args, lm, recalculate_props=True, directory=directory)
    global_lm = lm
